...
**`NOMD`** | Nominal Modifier | `CNN` news had little effect on the market
...
- Those annotations are very similar, but not 100% compatible, with [Universal dependencies specifications](http://universaldependencies.org/)