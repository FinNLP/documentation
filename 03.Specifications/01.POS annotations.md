...
- Typically, those annotations are compatible with [Penn Treebank POS tags](https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html) since the latter's set was used to train the lexicon, and the rules set, and being used to test POS tagger.